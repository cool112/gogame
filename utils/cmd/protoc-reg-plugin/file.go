...
import (
	...
	"github.com/cool112/gogame/utils"
)

const codeTemplate = `// Generated by github.com/cool112/gogame/utils/cmd/protoc-reg-plugin
...
func (self *msgModel) MsgID() string {
	return "proto."+utils.CapCamel2Const(self.Name())
}
